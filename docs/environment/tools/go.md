...
Нам нужна интегрированная среда разработки (IDE), чтобы писать код. Для этого есть множество сценариев, в этом примере мы используем  [Visual Studio Code](https://code.visualstudio.com/).
