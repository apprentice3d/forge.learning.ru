# Базовый пользовательский интерфейс (UI)
...
К этому моменту  вы можете запустить ваш проект, просто нажмите **play**, и откроется HTML-станица, что означает, что ваш проект создан корректно. Кнопки работать не будут ... давайте продолжим. 
